...
class GestionAdminController:
    ...
    # def cargar_datos_tabla(self):
        ...
        #         rol = datos.get("rol", "").lower()
        #         sexo = datos.get("sexo", "").lower()

        #         if rol == "administrador":
        #             tag_fila = 'par' if index % 2 == 0 else 'impar'

        #             if sexo == "masculino":
        #                 GDV.contador_masculino += 1
        #             else:
        #                 GDV.contador_femenino += 1
        ...
        #             # Sumar al total siempre
        #             self.vista.contador_total.set(self.vista.contador_total.get() + 1)

        #             # Sumar solo al que corresponde
        #             if sexo == "masculino":
        #                 self.vista.contador_masculino.set(self.vista.contador_masculino.get() + 1)
        #             else:
        #                 self.vista.contador_femenino.set(self.vista.contador_femenino.get() + 1)
    ...
    #                 # Tag según sexo e índice para color de fila
    #                 if sexo == "masculino":
    #                     tag_fila = 'masculino_par' if index % 2 == 0 else 'masculino_impar'
    #                     icono_sexo = "♂  Masculino"
    #                     self.vista.contador_masculino.set(self.vista.contador_masculino.get() + 1)
    #                 else:
    #                     tag_fila = 'femenino_par' if index % 2 == 0 else 'femenino_impar'
    #                     icono_sexo = "♀  Femenino"
    #                     self.vista.contador_femenino.set(self.vista.contador_femenino.get() + 1)
